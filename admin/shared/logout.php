...
// Calcular la base URL correctamente (debe apuntar a la raíz del proyecto, no a /admin)
$docRoot = rtrim(str_replace('\\', '/', $_SERVER['DOCUMENT_ROOT']), '/');
$projRoot = rtrim(str_replace('\\', '/', dirname(dirname(__DIR__))), '/'); // Subir 2 niveles desde admin/shared
